...
for bits in range(int(ceil(log(6)/log(2))+30),  int(ceil(log(6)/log(2))-1), -1):
	st_st0, st_st0_n, st_st1, st_st2, st_st3, st_st3_n = BitVecs('st_st0 st_st0_n st_st1 st_st2 st_st3 st_st3_n',bits)

	s = Solver();
	s.set("timeout", 1000000)
	s.add(Distinct(st_st0,st_st0_n,st_st1,st_st2,st_st3,st_st3_n))
